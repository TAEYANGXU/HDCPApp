...
class HDHM05Controller: BaseViewController ,UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func setupUI(){
        ...
        layout.itemSize = CGSize(width: Constants.kSCREENWITH/2-20, height: Constants.kSCREENWITH/2-20)
     ...
     func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        if imageView == nil {
            ...
            imageView?.snp_makeConstraints(closure: { (make) -> Void in
                ...
                make.width.equalTo(Constants.kSCREENWITH/2-20)
                make.height.equalTo(Constants.kSCREENWITH/2-20)
